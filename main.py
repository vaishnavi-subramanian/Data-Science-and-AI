...
def main():
    st.title("Vaishnavi Cosmic Seller Stats")

    st.write('Welcome to the Vaishnavi Cosmic Seller Stats Breakdown app. This was created by Vaishnavi S ')
    st.write("This App is Free. If you want to help support it, please consider buying a card from my [Vaishnavi Cosmic Seller Stats]")
    ...
    st.write('Looking to have some data analyzed for your business? Or Need help with a Data Project? I take on Freelance work. Email me at vaish.jana@gmail.com (Also open to full time job opportunities)')
